...
model TestCase
  ...
  IDEAS.Buildings.Validation.Cases.Case900Template case900Template(
    ...
    redeclare IDEAS.Buildings.Components.Occupants.Input
                                                   occNum,
    redeclare IDEAS.Buildings.Components.OccupancyType.OfficeWork
                                                            occTyp,
    mSenFac=1,
    n50=10,
  ...
  IDEAS.Fluid.HeatPumps.ScrollWaterToWater heaPum(
    ...
    datHeaPum=
        IDEAS.Examples.IBPSA.Data.Heating.Carrier_30AW015_15kW_4_9COP_R410A())
  ...
  IDEAS.Utilities.IO.SignalExchange.Read reaQFloHea(
  ...
  IDEAS.Utilities.IO.SignalExchange.Read reaQHeaPumEva(
  ...
  IDEAS.Utilities.IO.SignalExchange.Read reaQHeaPumCon(
  ...
  IDEAS.Utilities.IO.SignalExchange.Overwrite oveTSet(u(
      max=273.15 + 35,
      unit="K",
